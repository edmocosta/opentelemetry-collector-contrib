...
func init() {
	...
	englishLocale, err = NewLocale(&language.English)
	if err != nil {
		log.Fatal(err)
	}
...
func TestLayoutMismatch(t *testing.T) {
	...
	t.Run("Parse", func(t *testing.T) {
		...
		if err == nil || !errors.Is(err, ErrLayoutMismatch) {
...
func BenchmarkFormat(b *testing.B) {
	locale, err := NewLocale(&language.English)
	if err != nil {
		b.Error(err)
	}
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, err = Format("Mon Jan _2 2006 03:04:05PM", "Thu Oct 27 1988 11:53:29PM", locale)
		if err != nil {
			b.Error(err)
		}
	}
...
func BenchmarkParse(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, err = Parse("Mon Jan _2 2006 03:04:05PM", "Thu Oct 27 1988 11:53:29PM", locale)
		if err != nil {
			b.Error(err)
		}
	}
...
func BenchmarkParseInLocation(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, err = ParseInLocation("Mon Jan _2 2006 03:04:05PM", "Thu Oct 27 1988 11:53:29PM", locale, defaultLocation)
		if err != nil {
			b.Error(err)
		}
	}
